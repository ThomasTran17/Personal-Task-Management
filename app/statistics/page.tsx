...
import { calculateTaskStats } from '@/lib/statisticsHelpers';
import { StatCard } from '@/components/stats/StatCard';
import { TaskBreakdown } from '@/components/stats/TaskBreakdown';
import { ProgressSection } from '@/components/stats/ProgressSection';
  ...
  return (
    <main className="min-h-screen bg-white p-6 md:p-12">
      <div className="max-w-6xl mx-auto space-y-12">
        ...
        {stats.total > 0 && <ProgressSection completionRate={stats.completionRate} />}
      </div>
    </main>
  );
}
